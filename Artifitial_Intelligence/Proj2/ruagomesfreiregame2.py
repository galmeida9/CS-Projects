...
for nrep in range(0,NREP):
        ...
        #A.qValue(10); A.qValue(9); A.qValue(4); A.qValue(3); A.qValue(2); A.qValue(1); A.qValue(11); A.qValue(24)
        print("# testing phase")
        # in this phase your agent will execute what it learned in the world
        # the total reward obtained needs to be the optimal
        Jn = runagent(A, T, R, I = 1, learningphase=False, ntest = 10)
        ...
        print("# testing phase")
        Jn = runagent(A, T, R, I = 1, learningphase=False, ntest = 10)
        #A.qValue(1); A.qValue(2); A.qValue(6); A.qValue(7); A.qValue(8); A.qValue(9); A.qValue(10)
        val[3] += Jn
        print("average reward",Jn)        
